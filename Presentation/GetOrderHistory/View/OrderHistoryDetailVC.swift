...
class OrderHistoryDetailVC: UIViewController,UITableViewDataSource,UITableViewDelegate , OrderHistoryDetailProtocol {
    
    
    func showOrderHistoryDetail() {
       //Reload data to cells
